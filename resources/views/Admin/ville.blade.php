            ...
            <div class="overview">
                ...
                <div class="boxes">
                    <div class="box box1">
                        ...
                        <span class="text">Totale villes</span>
                        <span class="number">{{ $villes->count() }}</span>
                    </div>
                    <div>
                        {{ $chart1->container() }}
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <div class="pt-4">
                            <div class="form-input">
                                <label for="ville_name" class="d-block">Libellé :</label>
                                <input class="w-100 rounded-3" type="text" id="ville_name" name="name">
                            </div>
                        </div>
                        <div class="form-btn">
                    ...
                    <table class="content-table">
                        ...
                        <tbody>
                            @foreach ($villes as $key => $ville)
                                <tr>
                                    <td>{{ $key = $key + 1 }}</td>
                                    <td hidden>{{ $ville->id }}</td>
                                    <td>{{ $ville->name }}</td>
                                    <td><button type="button" class="EditeBtn" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal">
                                            <i class="uil uil-edit"></i>
                                        </button></td>
                                    <td><a href="{{ route('ville.delete', $ville->id) }}" class="DeleteBtn"><button><i
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog rounded-3">
            <div class="modal-content">
                <form method="POST" action="{{ route('ville.update') }}">
                    @csrf
                    ...
                    <div class="px-3 py-4">
                        ...
                        <div class="form-input">
                            <label class="d-block">Nouvelle libellé :</label>
                            <input class="rounded-3 w-100" type="text" id="ville_nameM" name="name_update">
                        </div>
